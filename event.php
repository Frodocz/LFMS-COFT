...
<div class="fancy">
    ...
    <p>
    <label><input type="checkbox" value="1" id="isallday" name="isallday" checked> All Day</label>
    <label><input type="checkbox" value="1" id="isend" name="isend" <?php echo $chk;?>> End Time</label>
    </p>
...
<div class="fancy">
    ...
    <label><input type="checkbox" value="1" id="isend" name="isend" <?php echo $end_chk;?>> End Time</label>
    </p>
