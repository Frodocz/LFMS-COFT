...
<head>
  <meta charset="UTF-8">
  <!-- Basic Page Needs -->
  <title>Paperless Lab | The User Book Facility Visit Page</title>
  <meta name="description" content="User Book Facility Visit Page for Paperless Lab.">
...
<body>
  ...
  <section id="userbookfacility">
    <div class="section-header">
      <h2 class="section-title text-center fadeInDown">Schedule A Visit For This Facility</h2>
    </div>
      ...
      <div class="row">
        <div class="col-lg-10 col-lg-offset-1">
          <div class="bookingtime">
            <h2 class="text-center">Schedule The Visit Time</h2>
            <div id='calendar'></div>
          </div>
        </div>
      </div>    
